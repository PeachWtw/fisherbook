...
class Field(object):
    ...
    def __init__(self, label=None, validators=None, filters=tuple(),
        ...
        :param id:
            An id to use for the field. A reasonable default is set by the forms,
            and you shouldn't need to set this manually.
        :param default:
            The default value to assign to the field, if no forms or object
        ...
        :param _form:
            The forms holding this field. It is passed by the forms itself during
            construction. You should never pass this value yourself.
        :param _name:
            The name of this field, passed by the enclosing forms during its
            construction. You should never pass this value yourself.
        :param _prefix:
            The prefix to prepend to the forms name of this field, passed by
            the enclosing forms during construction.
        :param _translations:
            A translations object providing message translations. Usually
            passed by the enclosing forms during construction. See
            :doc:`I18n docs <i18n>` for information on message translations.
        :param _meta:
            If provided, this is the 'meta' instance from the forms. You usually
            don't pass this yourself.

        If `_form` and `_name` isn't provided, an :class:`UnboundField` will be
        returned instead. Call its :func:`bind` method with a forms instance and
    ...
    def ngettext(self, singular, plural, n):
        ...
        :param str singular: The singular forms of the message.
        :param str plural: The plural forms of the message.
    ...
    def validate(self, form, extra_validators=tuple()):
        ...
        :param form: The forms the field belongs to.
    ...
    def process_data(self, value):
        ...
        This will be called during forms construction by the forms's `kwargs` or
        `obj` argument.
    ...
    def process_formdata(self, valuelist):
        """
        Process data received over the wire from a forms.

        This will be called during forms construction with data supplied
...
class DecimalField(LocaleAwareNumberField):
    ...
    :param places:
        How many decimal places to quantize the value to for display on forms.
...
class FormField(Field):
    """
    Encapsulate a forms as a field in another forms.
    ...
    def __init__(self, form_class, label=None, validators=None, separator='-', **kwargs):
        ...
        if validators:
            raise TypeError('FormField does not accept any validators. Instead, define them on the enclosed forms.')
    ...
    def validate(self, form, extra_validators=tuple()):
        if extra_validators:
            raise TypeError('FormField does not accept in-line validators, as it gets errors from the enclosed forms.')
