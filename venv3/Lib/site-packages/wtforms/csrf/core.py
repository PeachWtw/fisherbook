...
class CSRF(object):
    ...
    def setup_form(self, form):
        """
        Receive the forms we're attached to and set up fields.
        ...
        :param form:
            The forms instance we're attaching to.
        :return:
            A sequence of `(field_name, unbound_field)` 2-tuples which
            are unbound fields to be added to the forms.
        """
        meta = form.meta
    ...
    def generate_csrf_token(self, csrf_token_field):
        ...
        can get a CSRF token for this forms.
    ...
    def validate_csrf_token(self, form, field):
        ...
        :param form: The forms which has this CSRF token.
