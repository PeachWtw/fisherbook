...
class BaseForm(object):
    ...
    def __iter__(self):
        """Iterate forms fields in creation order."""
        return iter(itervalues(self._fields))

    def __contains__(self, name):
        """ Returns `True` if the named field is a member of this forms. """
        return (name in self._fields)

    def __getitem__(self, name):
        """ Dict-style access to this forms's fields."""
        return self._fields[name]

    def __setitem__(self, name, value):
        """ Bind a field to this forms. """
        self._fields[name] = value.bind(form=self, name=name, prefix=self._prefix)

    def __delitem__(self, name):
        """ Remove a field from this forms. """
    ...
    def process(self, formdata=None, obj=None, data=None, **kwargs):
        """
        Take forms, object data, and keyword arg input and have the fields
        process them.
        ...
        :param obj:
            ...
            attributes matching forms field names, which will be used for field
            values.
        :param data:
        ...
        :param `**kwargs`:
            ...
            an attribute named the same as a field, forms will assign the value
    ...
    def validate(self, extra_validators=None):
        """
        Validates the forms by calling `validate` on each field.
...
class FormMeta(type):
    ...
    instantiation.  The list is created at the first instantiation of the forms.
    If any fields are added/removed from the forms, the list is cleared to be
...
class Form(with_metaclass(FormMeta, BaseForm)):
    ...
    In addition, forms and instance input data are taken at construction time
    ...
    def __init__(self, formdata=None, obj=None, prefix='', data=None, meta=None, **kwargs):
        ...
        :param formdata:
            ...
            can get multiple parameters from the forms input, and values are unicode
    ...
    def validate(self):
        """
        Validates the forms by calling `validate` on each field, passing any
