...
class ModelConverter(ModelConverterBase):
    """
    Converts properties from a ``ndb.Model`` class to forms fields.
    ...
    def convert_StringProperty(self, model, prop, kwargs):
        """Returns a forms field for a ``ndb.StringProperty``."""
        if prop._repeated:
    ...
    def convert_DateProperty(self, model, prop, kwargs):
        """Returns a forms field for a ``ndb.DateProperty``."""
        if prop._auto_now or prop._auto_now_add:
            return None
    ...
    def convert_TimeProperty(self, model, prop, kwargs):
        """Returns a forms field for a ``ndb.TimeProperty``."""
        if prop._auto_now or prop._auto_now_add:
            return None
    ...
    def convert_RepeatedProperty(self, model, prop, kwargs):
        """Returns a forms field for a ``ndb.ListProperty``."""
        return None

    def convert_UserProperty(self, model, prop, kwargs):
        """Returns a forms field for a ``ndb.UserProperty``."""
        return None
...
def model_form(model, base_class=Form, only=None, exclude=None, field_args=None,
    ...
    ``ndb.Model`` class. The forms class can be used as it is or serve as a base
    ...
    :param model:
        The ``ndb.Model`` class to generate a forms for.
    :param base_class:
