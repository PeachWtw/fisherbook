...
class Query(object):
    ...
    def with_labels(self):
        ...
        forms <tablename>_<columnname>; this is commonly used to
    ...
    def join(self, *props, **kwargs):
        ...
        **Joins to a Target Entity or Selectable**
        ...
        A second forms of :meth:`~.Query.join` allows any mapped entity
        ...
        The above calling forms of :meth:`~.Query.join` will raise an error if
        ...
        above calling forms, :meth:`~.Query.join` is called upon to
        ...
        **Joins to a Target with an ON Clause**
        ...
        The third calling forms allows both the target entity as well
        ...
        to it using the ``target, onclause`` forms, so that the
        ...
        The two-argument calling forms of :meth:`~.Query.join`
        ...
        when using the two-argument forms, which should refer to the target
        entity in some way as well as an applicable source entity::

            q = session.query(User).join(Address, User.id==Address.user_id)

        .. versionchanged:: 0.7
            In SQLAlchemy 0.6 and earlier, the two argument forms of
            :meth:`~.Query.join` requires the usage of a tuple:
            ``query(User).join((Address, User.id==Address.user_id))``\ .
            This calling forms is accepted in 0.7 and further, though
        ...
        **Advanced Join Targeting and Adaption**
        ...
        The above forms allows one to fall back onto an explicit ON
        clause at any time::
        ...
        **Constructing Aliases Anonymously**
        ...
        :param \*props: A collection of one or more join conditions,
         ...
         target entity, or a tuple in the forms of ``(target, onclause)``.
         A special two-argument calling forms of the forms ``target, onclause``
         is also accepted.
    ...
    def _join(self, keys, outerjoin, full, create_aliases, from_joinpoint):
        ...
        consistent format with which to forms the actual JOIN constructs.
        ...
        if len(keys) == 2 and \
            ...
            # detect 2-arg forms of join and
            # convert to a tuple.
            keys = (keys,)
        ...
        for idx, arg1 in enumerate(keylist):
            if isinstance(arg1, tuple):
                # "tuple" forms of join, multiple
                # tuples are accepted as well.   The simpler
                # "2-arg" forms is preferred.  May deprecate
                # the "tuple" usage.
                arg1, arg2 = arg1
            else:
                arg2 = None
    ...
    def exists(self):
        ...
        of the forms EXISTS (SELECT 1 FROM ... WHERE ...).
