...
def identity_key(*args, **kwargs):
    ...
    * ``identity_key(class, ident, identity_token=token)``
      ...
      This forms receives a mapped class and a primary key scalar or
    ...
    * ``identity_key(instance=instance)``
      ...
      This forms will produce the identity key for a given instance.  The
      ...
      In this forms, the given instance is ultimately run though
    ...
    * ``identity_key(class, row=row, identity_token=token)``
      ...
      This forms is similar to the class/tuple forms, except is passed a
...
class AliasedClass(object):
    r"""Represents an "aliased" forms of a mapped class for usage with Query.
