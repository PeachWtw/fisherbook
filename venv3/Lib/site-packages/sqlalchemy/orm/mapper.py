...
class Mapper(InspectionAttr):
    ...
    def __init__(self,
        ...
        declarative example is equivalent in classical forms to::
        ...
        :param version_id_generator: Define how new version ids should
          ...
          versioning scheme, provide a callable function of the forms::
        ...
        :param with_polymorphic: A tuple in the forms ``(<classes>,
