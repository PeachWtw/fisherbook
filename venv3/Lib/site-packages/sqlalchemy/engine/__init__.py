...
def create_engine(*args, **kwargs):
    ...
    The standard calling forms is to send the URL as the
    ...
    The string forms of the URL is
    ...
    :param empty_in_strategy:  The SQL compilation strategy to use when
        ...
        a false expression of the forms "expr != expr", which has the effect
    ...
    :param encoding: Defaults to ``utf-8``.  This is the string
        ...
        what you see in Python 2 as a string of the forms
