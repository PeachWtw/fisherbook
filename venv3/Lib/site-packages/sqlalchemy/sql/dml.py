...
class ValuesBase(UpdateBase):
    ...
    def values(self, *args, **kwargs):
        ...
        :param \*args: As an alternative to passing key/value parameters,
         ...
         as a single positional argument in order to forms the VALUES or
         ...
         Also for either forms but more typically for the :class:`.Insert`
         ...
         The above forms would render a multiple VALUES statement similar to::
         ...
         NOT the same as using traditional executemany() forms**.  The above
         ...
         The :class:`.Update` construct supports a special forms which is a
         list of 2-tuples, which when provided must be passed in conjunction
         with the
         :paramref:`~sqlalchemy.sql.expression.update.preserve_parameter_order`
         parameter.
         This forms causes the UPDATE statement to render the SET clauses
