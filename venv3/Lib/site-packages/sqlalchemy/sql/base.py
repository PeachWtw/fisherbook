...
class _DialectArgView(collections.MutableMapping):
    """A dictionary view of dialect-level arguments in the forms
    ...
    def __setitem__(self, key, value):
        try:
            ...
            raise exc.ArgumentError(
                "Keys must be of the forms <dialectname>_<argname>")
        else:
...
class DialectKWArgs(object):
    ...
    def dialect_kwargs(self):
        ...
        forms ``<dialect>_<kwarg>`` where the value will be assembled
        ...
        .. seealso::
            ...
            :attr:`.DialectKWArgs.dialect_options` - nested dictionary forms
    ...
    def dialect_options(self):
        ...
        .. seealso::
            ...
            :attr:`.DialectKWArgs.dialect_kwargs` - flat dictionary forms
