...
class Join(FromClause):
    ...
    def _create_join(cls, left, right, onclause=None, isouter=False,
        ...
        .. seealso::
            ...
            :meth:`.FromClause.join` - method forms, based on a given left side
    ...
    def select(self, whereclause=None, **kwargs):
        ...
        The equivalent long-hand forms, given a :class:`.Join` object
        ``j``, is::
    ...
    def alias(self, sqlutil, name=None, flat=False):
        ...
        :class:`.Alias` from that.  So given a join of the forms::
    ...
    def __init__(self,
        ...
        :param columns:
          ...
          .. note::
            ...
            in the method forms of :func:`.select`, e.g.
            :meth:`.FromClause.select`.
        ...
        :param whereclause:
          A :class:`.ClauseElement` expression which will be used to forms the
        ...
        :param distinct=False:
          ...
          of column expressions - this is a special calling forms which
