...
class TypeEngine(Visitable):
    ...
    class Comparator(operators.ColumnOperators):
        ...
        def _adapt_expression(self, op, other_comparator):
            ...
            The method returns a tuple of the forms <operator>, <type>.
    ...
    def adapt(self, cls, **kw):
        """Produce an "adapted" forms of this type, given an "impl" class
        to work with.
    ...
    def compile(self, dialect=None):
        """Produce a string-compiled forms of this :class:`.TypeEngine`.
...
class TypeDecorator(SchemaEventTarget, TypeEngine):
    ...
    def type_engine(self, dialect):
        ...
        In most cases this returns a dialect-adapted forms of
