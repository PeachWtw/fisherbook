...
class ColumnOperators(Operators):
    ...
    def ilike(self, other, escape=None):
        ...
        In a column context, produces an expression either of the forms::
    ...
    def in_(self, other):
        ...
        * A list of literal values, e.g.::
          ...
          In this calling forms, the list of items is converted to a set of
        ...
        * An empty list, e.g.::
          ...
          In this calling forms, the expression renders a "false" expression,
          e.g.::
        ...
        * A bound parameter, e.g. :func:`.bindparam`, may be used if it
          ...
          In this calling forms, the expression renders a special non-SQL
          ...
          forms illustrated earlier.   If the statement were executed as::
        ...
        * a :func:`.select` construct, which is usually a correlated
          ...
          In this calling forms, :meth:`.ColumnOperators.in_` renders as given::
