...
class ClauseElement(Visitable):
    ...
    def _clone(self):
        ...
        # typically in the forms of column expressions still attached to the
        # old table.
        c._is_clone_of = self
...
class ColumnElement(operators.ColumnOperators, ClauseElement):
    ...
    usually refers to an input which is either already in the forms of a
...
class BindParameter(ColumnElement):
    ...
    def __init__(self, key, value=NO_ARG, type_=None,
        ...
        while the placeholder ``:name_1`` is rendered in the appropriate forms
...
class TextClause(Executable, ClauseElement):
    ...
    def columns(self, selectable, *cols, **types):
        ...
        The positional forms of :meth:`.TextClause.columns` also provides
...
class Case(ColumnElement):
    ...
    def __init__(self, whens, value=None, else_=None):
        ...
        :func:`.case` in its usual forms is passed a list of "when"
        ...
        expression to be compared.  In this forms, the :paramref:`.case.whens`
        ...
        :param whens: The criteria to be compared against,
         ...
         In the first forms, it accepts a list of 2-tuples; each 2-tuple
         ...
         In the second forms, it accepts a Python dictionary of comparison
         values mapped to a resulting value; this forms requires
