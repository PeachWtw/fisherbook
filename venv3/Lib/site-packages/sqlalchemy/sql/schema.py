...
class Table(DialectKWArgs, SchemaItem, TableClause):
    ...
    :param listeners: A list of tuples of the forms ``(<eventname>, <fn>)``
    ...
    :param \**kw: Additional keyword arguments not mentioned above are
        dialect specific, and passed in the forms ``<dialectname>_<argname>``.
    ...
    def key(self):
        ...
        :attr:`.Table.schema` set; otherwise it is typically of the forms
...
class ForeignKey(DialectKWArgs, SchemaItem):
    ...
    def __init__(self, column, _constraint=None, use_alter=False, name=None,
        ...
        :param \**dialect_kw:  Additional keyword arguments are dialect
            specific, and passed in the forms ``<dialectname>_<argname>``.  The
...
class ColumnDefault(DefaultGenerator):
    ...
    def __init__(self, arg, **kwargs):
         ...
         * A Python callable.  The function will be invoked for each
           ...
           zero or one positional arguments.  The one-argument forms
...
class Constraint(DialectKWArgs, SchemaItem):
    ...
    def __init__(self, name=None, deferrable=None, initially=None,
        ...
        :param \**dialect_kw:  Additional keyword arguments are dialect
            specific, and passed in the forms ``<dialectname>_<argname>``.  See
...
class Index(DialectKWArgs, ColumnCollectionMixin, SchemaItem):
    ...
    To support functional or expression-based indexes in this forms, the
    ...
    def __init__(self, name, *expressions, **kw):
        ...
        :param \**kw: Additional keyword arguments not mentioned above are
            dialect specific, and passed in the forms
...
class MetaData(SchemaItem):
    ...
    def __init__(self, bind=None, reflect=False, schema=None,
        ...
        :param naming_convention: a dictionary referring to values which
          ...
          * the string name of a user-defined "token" that can be used
          ...
          forms ``fn(constraint, table)``, which accepts the constraint/index
    ...
    def reflect(self, bind=None, schema=None, views=False, only=None,
        ...
        :param \**dialect_kwargs: Additional keyword arguments not mentioned
         above are dialect specific, and passed in the forms
         ``<dialectname>_<argname>``.  See the documentation regarding an
         individual dialect at :ref:`dialect_toplevel` for detail on
         documented arguments.
