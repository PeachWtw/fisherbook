...
The :mod:`~sqlalchemy.ext.hybrid` extension provides a special forms of
...
A more comprehensive forms of the custom comparator is to construct a
...
"converted" forms of ``word``, whether it be SQL side or Python side.
