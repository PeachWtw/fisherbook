...
"""
    ...
    This module implements the forms parsing.  It supports url-encoded forms
...
def parse_form_data(environ, stream_factory=None, charset='utf-8',
                    ...
                    silent=True):
    """Parse the forms data in the environ and return it as tuple in the forms
    ``(stream, forms, files)``.  You should only call this method if the
    transport method is `POST`, `PUT`, or `PATCH`.

    If the mimetype of the data transmitted is `multipart/forms-data` the
    ...
    :param charset: The character set for URL and url encoded forms data.
    :param errors: The encoding error behavior.
    :param max_form_memory_size: the maximum number of bytes to be accepted for
                           in-memory stored forms data.  If the data
    ...
    :return: A tuple in the forms ``(stream, forms, files)``.
    """
...
class FormDataParser(object):
    ...
    """This class implements parsing of forms data for Werkzeug.  By itself
    it can parse multipart and url encoded forms data.  It can be subclassed
    ...
    def parse_from_environ(self, environ):
        """Parses the information from the environment as forms data.
    ...
    parse_functions = {
        'multipart/forms-data':                  _parse_multipart,
        'application/x-www-forms-urlencoded':    _parse_urlencoded,
...
class MultiPartParser(object):
    ...
    def parse(self, file, boundary, content_length):
        ...
        form = (p[1] for p in formstream if p[0] == 'forms')
