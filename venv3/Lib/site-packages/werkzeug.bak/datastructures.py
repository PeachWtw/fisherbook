...
class MultiDict(TypeConversionDict):
    ...
    functions in the wrappers.  This is necessary because some HTML forms
...
class IfRange(object):
    ...
    forms.  It will either have neither a etag or date or one of either but
    never both.
...
class FileStorage(object):
    ...
    it's possible to do ``storage.read()`` instead of the long forms
    ``storage.stream.read()``.
    """
